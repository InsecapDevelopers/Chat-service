    ...
    <DialogPortal container={portalContainer || undefined}>
      ...
      >
        ...
        <DialogPrimitive.Close 
          ...
          onPointerUp={(e) => {
            // Fallback para Shadow DOM
            console.log('[DialogClose] onPointerUp triggered');
            if (!e.defaultPrevented) {
              // Simular click nativo en el elemento
          ...
          onMouseUp={(e) => {
            console.log('[DialogClose] onMouseUp triggered');
          }}
        >
          <X className="h-4 w-4" />
